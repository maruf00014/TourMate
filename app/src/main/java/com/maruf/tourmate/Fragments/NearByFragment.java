...
import com.maruf.tourmate.Nearby.NearbyPlaceAdapter;
import com.maruf.tourmate.Nearby.NearbyPlaceService;
import com.maruf.tourmate.Nearby.NearbyPlacesResponse;
import com.maruf.tourmate.Nearby.Result;
...
public class NearByFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        currentLongitude = getArguments().getDouble("lon");
    ...
    private void setMarker(List<Result> resultList) {
        ...
        for (int i = 0; i < resultList.size(); i++) {
            com.maruf.tourmate.Nearby.Location location = resultList.get(i).getGeometry().getLocation();
